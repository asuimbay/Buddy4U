...
def run():
    # ⚠️ REMOVE THIS LINE (it's already in main.py):
    # st.set_page_config(page_title="Buddy4U | Semester Wrapped", layout="wide")
    ...
    # --- Display Header ---
    st.title("🎉 Semester Wrapped")
    st.markdown("Celebrate your progress! Here's your personalized semester summary.")
    ...
    st.markdown("### 📈 Your Semester Progress")
    fig, ax = plt.subplots()
